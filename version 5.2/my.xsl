...
<!-- $Workfile: WcmPropertiesInfoPage.xsl $ $Revision: 1.276 $ $Date: Aug 
	26 2009 15:41:04 $ -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="readonly"
               select="$output/wcm:response/wcm:objectset/*/wcm:classdesc/wcm:allowinst=0"/>
    ...
    <xsl:param name="renamePropertyTo"
               select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.renamePropertyTo', 'Link To')"/>
    ...
    <xsl:variable name="wsLifecycle"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmGeneralPropsInfoPage_xsl.LifecycleLabel', 'Life Cycle State')"/>
    <xsl:variable name="lifeCycleText"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmGeneralPropsInfoPage_xsl.lifeCycleText', 'Life Cycle')"/>
    ...
    <xsl:variable name="property"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.property', 'Property')"/>
    <xsl:variable name="value"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.value', 'Value')"/>
    <xsl:variable name="multiObjectsIndicator"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.multiObjectsIndicator', 'Open list to view the values')"/>

    <!-- configurable labeling for term "Class" -->
    <xsl:param name="class"
               select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.class', '{0}: ',
                                       java:com.filenet.wcm.apps.server.util.prefs.LabelConfiguration.getConfiguredLabelResource('Class', $clientLocale) )"/>
    <xsl:variable name="wsRecordClass"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.recordClass', 'Record {0}:',
                                               java:com.filenet.wcm.apps.server.util.prefs.LabelConfiguration.getConfiguredLabelResource('Class', $clientLocale) )"/>
    <xsl:variable name="objectClass"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.objectClass', 'Object {0}: ',
                                             java:com.filenet.wcm.apps.server.util.prefs.LabelConfiguration.getConfiguredLabelResource('Class', $clientLocale) )"/>
    <xsl:variable name="requiredClass"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.requiredClass', 'Required {0}',
                                               java:com.filenet.wcm.apps.server.util.prefs.LabelConfiguration.getConfiguredLabelResource('Class', $clientLocale) )"/>
    <xsl:variable name="wsChangeClass"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.changeClass', 'Change {0}',
                                               java:com.filenet.wcm.apps.server.util.prefs.LabelConfiguration.getConfiguredLabelResource('Class', $clientLocale) )"/>
    <xsl:variable name="wsChildren"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.children', '{0}: ',
    ...
    <xsl:variable name="readOnlyText"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.readonly', '(readonly)')"/>
    <xsl:variable name="multiSeparator"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.multiseparator', '; ')"/>
    <xsl:variable name="noObjectSet"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.noObject', 'No Object(s) Set')"/>
    <xsl:variable name="valueNotDefined"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.valueNotDefined', 'Value Not Defined.')"/>
    <xsl:variable name="options"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.options', 'Options')"/>
    <xsl:variable name="addMajorVer"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.addMajorVer', 'Add as {0}',
                                               java:com.filenet.wcm.apps.server.util.prefs.LabelConfiguration.getConfiguredLabelResource('MajorVersion', $clientLocale) )"/>
    <xsl:variable name="chkinMajorVer"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.checkinMajorVer', 'Check in as {0}',
                                               java:com.filenet.wcm.apps.server.util.prefs.LabelConfiguration.getConfiguredLabelResource('MajorVersion', $clientLocale) )"/>
    <xsl:variable name="yes"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.yes', 'Yes')"/>
    <xsl:variable name="no"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.no', 'No')"/>
    <xsl:variable name="multiValue"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.multiValue', 'Multi-value:')"/>
    <xsl:variable name="useDefaultsLabel"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.useDefaultsLabel', 'Use Defaults')"/>
    <xsl:variable name="userDefinedLabel"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.userDefinedLabel', 'User Defined')"/>
    <xsl:variable name="wsLinkTo"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.linkTo', 'Link To')"/>
    <xsl:variable name="wsSelectValue"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.selectValue', 'Select Value')"/>
    <xsl:variable name="wsChangeValue"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.changeValue', 'Change Value')"/>
    <xsl:variable name="wsClear"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.clear', 'Clear')"/>

    <xsl:variable name="promoteAsMajorVersionText"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.promoteAsMajorVersionText', 'Promote As Major Version')"/>
    <xsl:variable name="requiredText"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.requiredText', 'Required')"/>
    <xsl:variable name="markingText"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.markingText', 'Marking')"/>
    <xsl:variable name="requiredMarkingText"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.requiredMarkingText', 'Required Marking')"/>
    <xsl:variable name="expandObjectProperties"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.expandObjectProperties', 'Expand Object Properties')"/>
    <xsl:variable name="collapseObjectProperties"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.collapseObjectProperties', 'Collapse Object Properties')"/>
    <xsl:variable name="wsGetInfoFor"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.getInfoFor', 'Get info for {0}')"/>
    <xsl:variable name="wsSelectObject"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.selectObject', 'Select Object')"/>
    <xsl:variable name="systemProperties"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.systemProperties', 'System Properties')"/>
    <xsl:variable name="hideSystemPropertiesText"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.hideSystemPropertiesText', 'Hide System Properties')"/>
    <xsl:variable name="showSystemPropertiesText"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.showSystemPropertiesText', 'Show System Properties')"/>
    <xsl:variable name="onApproval"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.onApproval', 'On Approval')"/>
    <xsl:variable name="wsCompoundDocumentHeader"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.compoundDocumentHeader', 'Compound Document')"/>
    <xsl:variable name="wsCompoundDocument"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.compoundDocument', 'Compound Document:')"/>
    <xsl:variable name="wsShow"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.show', 'Show')"/>
    <xsl:variable name="wsUseArrowKeys"
                  select="java:com.filenet.wcm.toolkit.util.WcmString.new($clientLocale, 'server.WcmPropertiesInfoPageXSL.useArrowKeys', 'Use up and down arrows to change the selection')"/>

    <xsl:variable name="encodedObjectStoreName">
        <xsl:if test="$output">
            <xsl:value-of
                    select="java:com.filenet.wcm.toolkit.util.WcmEncodingUtil.encodeLabel(string($output/wcm:response/wcm:objectset/*/wcm:objectstore/wcm:name))"/>
        </xsl:if>
    </xsl:variable>

    <xsl:variable name="allPropDescs"
                  select="wcm:response/wcm:objectset/wcm:objectstore/wcm:classdesc/wcm:propdescs/wcm:propdesc"/>
    <xsl:variable name="propDescs"
                  select="$allPropDescs[wcm:ishidden!=1][wcm:issysowned=0 or (wcm:isreadonly!=1 and wcm:setability!=3)][wcm:datatype!=1]"/>
    <xsl:variable name="classPropDescs"
                  select="$propDescs[wcm:symname!='ITXFormTemplate' and wcm:symname!='FormPolicy' and wcm:symname!='MimeType' and wcm:symname!='SourceDocument' and wcm:symname!='RecordInformation' and wcm:symname!='DestinationDocuments' and wcm:symname!='CompoundDocumentState']"/>
...
<!-- <=IBA -->
    ...
    <xsl:template match="/">
        ...
        <xsl:if test="$output or $readonly">
            ...
            <!-- Display document name and reference to document with version -->
            <xsl:call-template name="displayClassName"/>

            <!-- SHOW CLASS NAME FIELD, IT'S VALUE AND REFERENCE -->
            <xsl:call-template name="showClassName"/>

            <!-- SHOW TABLE WITH PROPERTY NAMES(THE 1ST COLUMN), VALUES(THE 2ND COLUMN) AND ACCESS(THE 3RD COLUMN) -->
            <xsl:call-template name="showPropertyTable"/>
    ...
    <!--++++++++++++++++++++++++++++++++++ SHOW (CLASS NAME) DEPENDING ON TYPE OF OBJECT ++++++++++++++++++++++++++++++++++ -->
    ...
    <xsl:template name="showClassName">
        ...
        <xsl:choose>
            ...
            <!-- SHOW CLASS NAME OF SINGLE PROPERTY OBJECT -->

            <xsl:when test="$singleProperty">

                <xsl:call-template name="propertyHeader">
                    <xsl:with-param name="className"
                                    select="$allPropDescs[wcm:symname=$singleProperty]/wcm:reqclass/wcm:dispname"/>
            ...
            <xsl:otherwise>
                ...
                <xsl:choose>
                    ...
                    <!-- SHOW CLASS NAME OF OBJECT WITH OUTPUT -->

                    <xsl:when test="$output">

                        <xsl:call-template name="propertyHeader">
                            <xsl:with-param name="className"
                                            select="$output/wcm:response/wcm:objectset/*/wcm:classdesc/wcm:name"/>
                            <xsl:with-param name="isReadOnly" select="$readonly"/>
                        </xsl:call-template>

                    </xsl:when>

                    <!-- SHOW CLASS NAME OF PROPERTY OBJECT WITHOUT OUTPUT-->
    ...
    <!--++++++++++++++++++++++++++++++++++ SHOW ELEMENT WITH ID OF OBJECT ++++++++++++++++++++++++++++++++++ -->

    <xsl:template name="addObjectIdElement">

        <xsl:if test="$output">

            <div>
                <xsl:attribute name="id">objectIdElement</xsl:attribute>
                <xsl:attribute name="objectId">
                    <xsl:value-of
                            select="$output/wcm:response/wcm:objectset/*/wcm:id"/>
                </xsl:attribute>
            </div>
    ...
    <!--++++++++++++++++++++++++++++++++++ SHOW PROPERTY TABLE DEPENDING ON TYPE OF OBJECT++++++++++++++++++++++++++++++++++ -->

    <!-- IBA => -->


    <xsl:template name="showPropertyTable">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$singleProperty">
                ...
                <xsl:call-template name="showSinglePropertyTable"/>
            ...
            <xsl:otherwise>
                ...
                <tr>
                    ...
                    <td id="propertiesArea">


                        <!-- TABS AREA -->

                        <xsl:call-template name="tabsArea"/>

                        <!-- ADD ELEMENT WITH OBJECT ID ATTRIBUTE (FOR SAVING PAGE) -->

                        <xsl:call-template name="addObjectIdElement"/>

                        <!-- AREA FOR TABLES WITH TABS -->

                        <xsl:call-template name="tablesArea"/>

                        <!-- TABLE WITH <th> and <tr> PROPERTIES -->
                            ...
                            <tbody>
                                    ...
                                    <xsl:when test="$output">
                                        ...
                                        <xsl:if test="$showSystemProperties">
                                            ...
                                            <xsl:if test="$expandSystemProperties='false'">
                                                <xsl:call-template name="propertyLoop">
                                                    <xsl:with-param name="propdescs"
                                                                    select="$filteredPropDescs/wcm:response/wcm:objectset/wcm:objectstore/wcm:classdesc/wcm:propdescs//wcm:propdesc"/>
                                                    <xsl:with-param name="theProperties" select="$output"/>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$rmProperties">
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <img alt="" src="images/web/common/Spacer.gif" width="1"
                                                     height="6"/>
                                            </td>
                                        </tr>
                                        ...
                                        <xsl:call-template name="propertyLoop">
                                            <xsl:with-param name="propdescs"
                                                            select="$rmPropDescs/wcm:response/wcm:objectset/wcm:objectstore/wcm:classdesc/wcm:propdescs//wcm:propdesc[wcm:ishidden!=1][wcm:issysowned=0 or (wcm:isreadonly!=1 and wcm:setability!=3)][wcm:datatype!=1]"/>
                                ...
                                <xsl:if test="$showPromote=true()">
                                    <xsl:if
                                            test="(($isCheckin=1 or $isCreate=1) and $objectType='document') and $readonly=false()">
    ...
    <!--++++++++++++++++++++++++++++++++++ SHOW SINGLE PROPERTY PROPERTY TABLE ++++++++++++++++++++++++++++++++++ -->
    <xsl:template name="showSinglePropertyTable">
            ...
            <td id="propertiesArea">
                ...
                <table id="propertiesTable">
                    ...
                    <tbody>
                        ...
                        <xsl:call-template name="propertyLoop">
                            <xsl:with-param name="propdescs"
                                            select="$allPropDescs[wcm:symname=$singleProperty]"/>
                            <xsl:with-param name="theProperties" select="$output"/>
                            <xsl:with-param name="isReadOnly" select="$readonly"/>
                        </xsl:call-template>
    ...
    <xsl:template name="tableHeaderRow">
        ...
        <tr>
            ...
            <th class="wcmFormMainHeader" width="1%">
                ...
                <img alt="" src="images/web/common/Spacer.gif" width="16"
                     height="16"/>
                ...
                <xsl:choose>
                    <xsl:when test="$expandSystemProperties='true'">
                        <xsl:choose>
                            <xsl:when test="string-length($formName)>0">
                                <a
                                        href="javascript:document.forms.{$formName}.action='{$eventURL}&amp;eventName=SystemProperties&amp;showSystemProperties=1';document.forms.{$formName}.submit()">
                                    <img width="16" height="16" border="0"
                                         src="images/action/ShowContents16.gif" title="{$showSystemPropertiesText}"/>
                                </a>
                                <img height="16" width="6" title="" src="images/state/None16.gif"/>
                                <a class="wcmListViewActionLink"
                                   href="javascript:document.forms.{$formName}.action='{$eventURL}&amp;eventName=SystemProperties&amp;showSystemProperties=1';document.forms.{$formName}.submit()">
                            ...
                            <xsl:otherwise>
                                <a
                                        href="{$eventURL}&amp;eventName=SystemProperties&amp;showSystemProperties=1">
                                    <img width="16" height="16" border="0"
                                         src="images/action/ShowContents16.gif" title="{$showSystemPropertiesText}"/>
                                </a>
                                <img height="16" width="6" title="" src="images/state/None16.gif"/>
                    ...
                    <xsl:otherwise>
                        <xsl:choose>
                            <xsl:when test="string-length($formName)>0">
                                <a
                                        href="javascript:document.forms.{$formName}.action='{$eventURL}&amp;eventName=SystemProperties&amp;showSystemProperties=0';document.forms.{$formName}.submit()">
                                    <img width="16" height="16" border="0"
                                         src="images/action/HideContents16.gif" title="{$hideSystemPropertiesText}"/>
                                </a>
                                <img height="16" width="6" title="" src="images/state/None16.gif"/>
                                <a class="wcmListViewActionLink"
                                   href="javascript:document.forms.{$formName}.action='{$eventURL}&amp;eventName=SystemProperties&amp;showSystemProperties=0';document.forms.{$formName}.submit()">
                            ...
                            <xsl:otherwise>
                                <a
                                        href="{$eventURL}&amp;eventName=SystemProperties&amp;showSystemProperties=0">
                                    <img width="16" height="16" border="0"
                                         src="images/action/HideContents16.gif" title="{$hideSystemPropertiesText}"/>
                                </a>
                                <img height="16" width="6" title="" src="images/state/None16.gif"/>
    ...
    <xsl:template name="propertyHeader">
        ...
        <xsl:choose>
            <xsl:when
                    test="$isCheckin=0 and $isCreate=0 and $objectType!='securitypolicy'">
                <tr>
                    <td colspan="3">
                                ...
                                <xsl:if test="$printViewURL">
                                    <xsl:variable name="newPrintViewURL">
                                        <xsl:choose>
                                            <xsl:when test="$expandSystemProperties='true'">
                                                <xsl:value-of
                                                        select="concat($printViewURL, '&amp;expandSystemProps=true')"/>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:value-of
                                                        select="concat($printViewURL, '&amp;expandSystemProps=false')"/>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:variable>
                                    <td align="right" width="1%" nowrap="true">
                                        <a target="_blank" href="{$newPrintViewURL}">
                                            <img width="16" height="16" border="0" src="{$printViewIcon}"
                                                 title="{$printViewCommand}"/>
                                        </a>
                                        <img height="16" width="6" title="" src="images/state/None16.gif"/>
    ...
    <xsl:template name="propertyLoop">
        ...
        <xsl:variable name="newPropDescs"
                      select="$propdescs[wcm:symname!='SecurityTemplates' and wcm:symname!=$filterProperty and wcm:symname!=$filterProperty2]"/>

        <xsl:variable name="propertyNode"
                      select="$theProperties/wcm:response/wcm:objectset/*/wcm:properties/wcm:property"/>
        <xsl:for-each select="$newPropDescs">
            ...
            <!-- set newValue: either comma separated multi-value, single value, or
                the default propdef -->
            <xsl:variable name="newValue">
                <xsl:choose>
                    ...
                    <xsl:when test="$NAME='ContentSize'">
                        <xsl:value-of
                                select="java:com.filenet.wcm.toolkit.server.util.WcmUi.formatContentSize(string($VALUE), string($locale))"/>
                    </xsl:when>
                    <xsl:otherwise>
            ...
            <!--++++++++++++++++++++++++++++++++++ End Set Variables, Start showing
                html ++++++++++++++++++++++++++++++++++ -->
            <tr>

                <!-- IBA => -->

                <!-- Make attribute "tab" with tab name for every property that means this property should be in tab with such name -->
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="wcm:isvalreq=1 and wcm:markings">
                                    <img title="{$requiredMarkingText}" border="0"
                                         src="images/state/RequiredMarking16.gif" width="16" height="10"/>
                                </xsl:when>
                                <xsl:when test="wcm:markings">
                                    <img title="{$markingText}" border="0"
                                         src="images/state/Marking16.gif" width="8" height="10"/>
                                </xsl:when>
                                <xsl:when test="wcm:isvalreq=1">
                                    <img title="{$requiredText}" border="0"
                                         src="images/state/Required16.gif" alt="{$requiredText}" width="16"
                                         height="16"/>
                                </xsl:when>
                ...
                <td scope="row" width="170" nowrap="true">        <!-- Property name -->
                    ...
                    <xsl:choose>
                        <xsl:when
                                test="$propertyExceptions and $propertyExceptions//wcm:error/wcm:symname=$NAME">
                            <xsl:variable name="errorMessage"
                                          select="java:com.filenet.wcm.toolkit.util.WcmEncodingUtil.decodeLabel(string($propertyExceptions//wcm:error[wcm:symname=$NAME]/wcm:message))"/>
                ...
                <td width="100%">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$checkReadOnly = 1">
                                            <xsl:call-template name="getHTMLFormInput">
                                                <xsl:with-param name="theProperty" select="$theProperty"/>
                                                <xsl:with-param name="checkReadOnly"
                                                                select="$checkReadOnly"/>
                                        ...
                                        <xsl:otherwise>
                                            <input type="radio" class="wcmFormText" name="releaseDateOption"
                                                   value="0">
                                            ...
                                            <br/>
                                            <input type="radio" title="{$onApproval}" class="wcmFormText"
                                                   name="releaseDateOption" value="1">
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="getHTMLFormInput">
                                                ...
                                                <xsl:with-param name="typeOfObject" select="$typeOfObject"/>
                                                <xsl:with-param name="variableName" select="wcm:symname"/>
                                                <xsl:with-param name="theProperties"
                    ...
                    <xsl:variable name="multiObjectsProp"
                                  select="$multiObjects/wcm:response/wcm:objectset/*/wcm:properties/wcm:property[wcm:symname=$NAME]"/>
                    <xsl:if test="$multiObjectsProp/wcm:values/wcm:value">
                        <xsl:choose>
                            <xsl:when
                                    test="$expandedProperties/wcm:response/wcm:objectset/*/wcm:properties/wcm:property[wcm:symname=$NAME]/wcm:values/wcm:value">
                            </xsl:when>
                            <xsl:otherwise>
                ...
                <xsl:if test="$expandedPropID=wcm:symname and not($showIndented)">        <!-- Expanded Properties -->
                    ...
                    <xsl:choose>
                        <xsl:when test="wcm:cardinality!='0'">   <!-- Multi Value -->
                            <xsl:variable name="expandedProperty"
                                          select="$expandedProperties/wcm:response/wcm:objectset/*/wcm:properties/wcm:property[wcm:symname=$NAME]"/>
                                            ...
                                            <td nowrap="true">
                                                ...
                                                <xsl:if test="$showInfoLink">
                                                    <xsl:variable name="expandedObjectType">
                                                        <xsl:choose>
                                                            <xsl:when
                                                                    test="$expandedProperty/wcm:objecttype=2">
                                                                <xsl:value-of select="'folder'"/>
                                                            </xsl:when>
                                                            <xsl:when
                                                                    test="$expandedProperty/wcm:objecttype=1">
                                                                <xsl:value-of select="'document'"/>
                                                            </xsl:when>
                                                            <xsl:when
                                                                    test="$expandedProperty/wcm:objecttype=-100">
                                                                <xsl:value-of select="'storedsearch'"/>
                                                            </xsl:when>
                                                            <xsl:when
                                                                    test="$expandedProperty/wcm:objecttype=-101">
                                                                <xsl:value-of select="'publishtemplate'"/>
                                                            </xsl:when>
                                                            <xsl:when
                                                                    test="$expandedProperty/wcm:objecttype=15">
                                                                <xsl:value-of select="'customobject'"/>
                                                            </xsl:when>
                                                            <xsl:when
                                                                    test="$expandedProperty/wcm:objecttype=1204">
                                                                <xsl:value-of select="'subscribedevent'"/>
                                                            </xsl:when>
                                                        </xsl:choose>
                                                    </xsl:variable>

                                                    <!-- don't display object info icon if object type list in filterObjectType
                                                        variable -->
                                                    <xsl:if test="$expandedObjectType!=$filterObjectType">
                                                            ...
                                                            <xsl:choose>
                                                                <xsl:when test="$windowId != ''">
                                                                    <xsl:variable name="fullURL"
                                                                                  select="concat($currentPageURL, '?windowId=', $rawWindowId)"/>
                                                                    <xsl:value-of
                                                                            select="java:com.filenet.wcm.toolkit.util.WcmEncodingUtil.encodeURL(string($fullURL))"/>
                                                                </xsl:when>
                                                                <xsl:otherwise>
                                                        ...
                                                        <xsl:if test="$expandedPropID!='SubscribedEvents'">
                                                            <xsl:variable name="infoLinkURL"
                                                                          select="concat($eventURL,
                                                                '&amp;eventName=',         'GetInfo',
                                                            ...
                                                            <a>
                                                                <xsl:attribute name="href">
                                                                    <xsl:choose>
                                                                        <xsl:when
                                                                                test="string-length($formName)>0">
                                                                            <xsl:value-of
                                                                                    select="concat('javascript:document.forms.', $formName, '.action=', &quot;'&quot;, $infoLinkURL, &quot;'&quot;, ';document.forms.', $formName, '.submit();')"/>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                            <xsl:value-of
                                                                                    select="$infoLinkURL"/>
                                                                ...
                                                                <img
                                                                        title="{java:toString($wsGetInfoFor, string(wcm:namevalue))}"
                                                                        border="0"
                                                                        src="images/action/GetInfo16.gif"
                                                                        width="16"
                                                                        height="16"/>
                                                            </a>
                                                        </xsl:if>
        ...
        <xsl:choose>
            <xsl:when test="$compoundDocumentState = false()">
                <xsl:call-template name="getCdSection">
                    <xsl:with-param name="cdPropDesc"
                                    select="$allPropDescs[wcm:symname = 'CompoundDocumentState']"/>
                </xsl:call-template>
            </xsl:when>
    ...
    <xsl:template name="getCdSection">
        ...
        <tr class="wcmFormRowEven">
            <td class="wcmFormText" width="1%">
                <img title="{$requiredText}" src="images/state/Required16.gif"
                     alt="{$requiredText}" width="16" height="16"/>
            </td>
            <td>
            ...
            <td>
                ...
                <xsl:variable name="value">
                    <xsl:variable name="currentValue"
                                  select="$output/wcm:response/wcm:objectset/*/wcm:properties/wcm:property[wcm:symname = 'CompoundDocumentState']/wcm:value"/>
                    <xsl:choose>
                ...
                <xsl:call-template name="BooleanValue">
                    ...
                    <xsl:with-param name="readonly"
                                    select="$isReadOnly or $canChangeCDState = false()"/>
        ...
        <tr class="wcmFormRowOdd">
            ...
            <td>
                <a class="wcmFormLink"
                   href="javascript:document.forms.{$formName}.action='{$eventURL}&amp;eventName=ShowChildren&amp;mode={$isReadOnly}';document.forms.{$formName}.submit()">
                    <xsl:value-of select="$wsShow"/>
                </a>&#160;
                <xsl:if test="$isReadOnly = false() and $canEditCD">
                    <a class="wcmFormLink"
                       href="javascript:document.forms.{$formName}.action='{$eventURL}&amp;eventName=AddChild';document.forms.{$formName}.submit()">
    ...
    <xsl:template name="optionSection">
        ...
        <tr class="wcmFormRowEven">
            <td class="wcmFormText" width="1%">
                <img alt="{$wsUseArrowKeys}" src="images/web/common/Spacer.gif"
                     width="16" height="16"/>
            </td>
                        ...
                        <a class="wcmFormLink" href="#">
                            <xsl:attribute name="onclick">
                                ...
                                <xsl:variable name="ru"
                                              select="java:com.filenet.wcm.toolkit.util.WcmEncodingUtil.encodeURL(string($returnUrl))"/>
                                ...
                                <xsl:value-of select="$rootClassId"/>
                                <xsl:if
                                        test="$isCheckin = 0 and $lockSelectClassOS">
                                    <xsl:value-of
                                            select="$encodedObjectStoreName"/>
                                </xsl:if>
                                <xsl:if test="$includedClasses">
                                    <xsl:for-each select="$includedClasses">
                                        ...
                                        <xsl:value-of
                                                select="java:com.filenet.wcm.toolkit.util.WcmEncodingUtil.encodeLabel(.)"/>
                                    </xsl:for-each>
                                </xsl:if>
            ...
            <xsl:if test="$showApply=true()">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img title="{$lifeCycleText}" border="0"
                             src="images/state/LifeCycle16.gif" width="16" height="16"/>
                    </td>
