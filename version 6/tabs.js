...
function saveTabIndexOfSelectedTab (tabIndex) {
    ...
    try {
        sessionStorage.setItem(TAB_INDEX_NAME_FOR_SAVING, tabIndex);
    } catch (e) {
...
function getLastTabIndex () {
    ...
    var key = TAB_INDEX_NAME_FOR_SAVING;
    try {
        var tabIndex = sessionStorage.getItem(key);
